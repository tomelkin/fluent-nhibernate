...
namespace FluentNHibernate.Specs.FluentInterface.SubclassMapSpecs
{
    ...
    {
        Because of = () =>
            mapping = map_as_subclass<EntityWithPropertiesParent, EntityWithProperties>(o => o.Map(x => x.Name));
    ...
    {
        Because of = () =>
            mapping = map_as_subclass<EntityWithFieldsParent, EntityWithFields>(o => o.Map(x => x.Name));
    ...
    {
        Because of = () =>
            mapping = map_as_subclass<EntityWithPrivatePropertiesParent, EntityWithPrivateProperties>(o => o.Map(Reveal.Property<EntityWithPrivateProperties>("Name")));
